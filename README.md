...
An online multiplayer Tetris game built in JavaScript.

Built with Node.js on the server, React and Redux on the client, with socket.io for real-time communication.
